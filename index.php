<html>
  ...
  <body>
    ...
    <div class="col-container-full customers-slider">
      <div id="slider" class="flexslider">
		<ul class="slides">
			<li>
			  <img src="images/slider/1.jpg" height="400" />
			</li>
			<li>
			  <img src="images/slider/2.jpg" height="400" />
			</li>
			<li>
			  <img src="images/slider/3.jpg" height="400" />
			</li>
	    </ul>
      </div>
    </div>
	<div class="col-container-full todays-special">
		<div class="day monday">Jerk Chicken and Rice $11.25 tax in!! Come before 12 noon and get a free drink!</div> 
		<div class="order-special-online">
			<div class="order-form">
				...
				<form name="orderForm" method="post" action="#">
					...
					<textarea name="instructions" id="instructions"></textarea><br /><br />
					<input type="submit" name="submit" class="order-button" value="Order now" />
				</form>
			</div>
			<div class="chef-holder"></div>
		</div>	
	</div>
    <div class="col-container">
      <div class="col-3">
        <div class="index-3-box">
          <div class="image"><img src="images/boxes/fish-and-chips.jpg" border="0" /></div>
          <div class="title">
            <h1>Take Out Specials</h1>
          </div>
		  <div class="content">
		  <p>Come and enjoy our daily specials. More items available from the take out menu every day.</p>
		  </div>
        </div>
      </div>
      <div class="col-3">
        <div class="index-3-box">
          <div class="image"><img src="images/boxes/jerk-chicken.jpg" border="0" /></div>
          <div class="title">
            <h1>Frozen Meals</h1>
          </div>
		  <div class="content">
      ...
      <div class="col-3">
        <div class="index-3-box">
          <div class="image"><img src="images/boxes/sushi.jpg" border="0" /></div>
          <div class="title">
            <h1>Catering</h1>
          </div>
		  <div class="content">
		  <p>From <a href="#">Weddings</a>, <a href="#">Special events</a>, <a href="#">Corporate Events</a> or <a href="#">Home Entertaining</a>, we strive to make your occasion a memorable one!</p>
		  </div>
        </div>
      </div>
    </div>
